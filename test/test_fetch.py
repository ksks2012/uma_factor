...
class TestHorseFetcher(unittest.TestCase):
    ...
    def test_horse_info_in_text(self):
        self.horse_fetcher._gen_horse_info_in_text()
    ...
    def test_horse_info_in_index(self):
        self.horse_fetcher._gen_horse_info_in_index()
        horse_info = self.horse_fetcher.horse_info
        print(horse_info)
        result = {'horse_name': '神鷹☆Numero1', 'blue': {4: 2}, 'red': {4: 1}, 'white': {46: 1, 61: 1, 0: 1, 52: 1, 67: 1}}
